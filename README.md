...
## Table of Contents
- [Why use This](https://github.com/RedEchidnaUK/AutoShutdownSchedule#why-use-this)
- [Credits](https://github.com/RedEchidnaUK/AutoShutdownSchedule#credits)
- [What it does](https://github.com/RedEchidnaUK/AutoShutdownSchedule#what-it-does)
- [Tag-based power schedule](https://github.com/RedEchidnaUK/AutoShutdownSchedule#tag-based-power-schedules)
- [Tag content](https://github.com/RedEchidnaUK/AutoShutdownSchedule#tag-content)
  - [Get to know datetime](https://github.com/RedEchidnaUK/AutoShutdownSchedule#get-to-know-datetime)
- [Schedule tag examples](https://github.com/RedEchidnaUK/AutoShutdownSchedule#schedule-tag-examples)
- [What the runbook does](https://github.com/RedEchidnaUK/AutoShutdownSchedule#what-the-runbook-does)
- [Runbook logs](https://github.com/RedEchidnaUK/AutoShutdownSchedule#runbook-logs)
- [Performance](https://github.com/RedEchidnaUK/AutoShutdownSchedule#performance)
- [Testing](https://github.com/RedEchidnaUK/AutoShutdownSchedule#testing)
- [Azure modules](https://github.com/RedEchidnaUK/AutoShutdownSchedule#azure-modules)
- [Setting it up in Azure](https://github.com/RedEchidnaUK/AutoShutdownSchedule#setting-it-up-in-azure)
  - [Prerequisites](https://github.com/RedEchidnaUK/AutoShutdownSchedule#prerequisites)
  - [Import runbook](https://github.com/RedEchidnaUK/AutoShutdownSchedule#import-runbook)
  - [Create credential asset](https://github.com/RedEchidnaUK/AutoShutdownSchedule#create-credential-asset)
  - [Create variables for subscription name and time zone](https://github.com/RedEchidnaUK/AutoShutdownSchedule#create-variables-for-subscription-name-and-time-zone)
  - [Schedule the runbook](https://github.com/RedEchidnaUK/AutoShutdownSchedule#schedule-the-runbook)
  - [Configure shutdown schedule tags](https://github.com/RedEchidnaUK/AutoShutdownSchedule#configure-shutdown-schedule-tags)
  - [Initial testing](https://github.com/RedEchidnaUK/AutoShutdownSchedule#initial-testing)
  - [Troubleshooting](https://github.com/RedEchidnaUK/AutoShutdownSchedule#troubleshooting)
  - [Automation account configuration](https://github.com/RedEchidnaUK/AutoShutdownSchedule#automation-account-configuration)
